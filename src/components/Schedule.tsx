        ...
        <React.Fragment>
          <IonItem>
            <div slot="start" className="ion-text-center">
              ...
              <IonBadge color="light">{new Date(raceSchedule.sessions.fp1).toLocaleString('default', { month: 'short' })}</IonBadge>
            </div>
            <IonLabel>
          ...
          <IonItem>
            <div slot="start" className="ion-text-center">
              ...
              <IonBadge color="light">{new Date(raceSchedule.sessions.fp2).toLocaleString('default', { month: 'short' })}</IonBadge>
            </div>
            <IonLabel>
          ...
          <IonItem>
            <div slot="start" className="ion-text-center">
              ...
              <IonBadge color="light">{new Date(raceSchedule.sessions.fp3).toLocaleString('default', { month: 'short' })}</IonBadge>
            </div>
            <IonLabel>
          ...
          <IonItem button onClick={() => _handleClick(season, round, 'qualifying', raceSchedule.sessions.qualifying)}>
            <div slot="start" className="ion-text-center">
              ...
              <IonBadge color="light">{new Date(raceSchedule.sessions.qualifying).toLocaleString('default', { month: 'short' })}</IonBadge>
            </div>
            <IonLabel>
          ...
          <IonItem button onClick={() => _handleClick(season, round, 'race', raceSchedule.sessions.gp)}>
            <div slot="start" className="ion-text-center">
              ...
              <IonBadge color="light">{new Date(raceSchedule.sessions.gp).toLocaleString('default', { month: 'short' })}</IonBadge>
            </div>
            <IonLabel>
